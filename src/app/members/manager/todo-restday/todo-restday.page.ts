...
@Component({
    selector: 'app-todo-restday',
    templateUrl: './todo-restday.page.html',
    styleUrls: ['./todo-restday.page.scss'],
})
export class TodoRestdayPage implements OnInit {
    contentType: string;
    ...
    getList() {
        ...
        this.todoProv.restDayList(this.allPage+'').then(res=>{
